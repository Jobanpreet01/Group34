...
<!--update button-->
<td><button style="background-color:#73b59e;box-shadow:0 0 20px rgba(0,0,0,0.15);" type="submit" onclick="myAlert()" class="btn">Update Quantity</button></td>
      </form>
...
<!--update button-->
<td><button style="background-color:#73b59e;box-shadow:0 0 20px rgba(0,0,0,0.15);" type="submit" onclick="myAlert()" class="btn">Update Order Status</button></td>
      </form>
